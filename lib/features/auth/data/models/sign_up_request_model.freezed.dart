...
mixin _$SignUpRequestModel {
 ...
 String get name; String get email; String get password; String get avatar;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SignUpRequestModel&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.avatar, avatar) || other.avatar == avatar));
}
...
@override
String toString() {
  return 'SignUpRequestModel(name: $name, email: $email, password: $password, avatar: $avatar)';
}
...
/// Create a copy of SignUpRequestModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? email = null,Object? password = null,Object? avatar = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String name,  String email,  String password,  String avatar)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignUpRequestModel() when $default != null:
return $default(_that.name,_that.email,_that.password,_that.avatar);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String name,  String email,  String password,  String avatar)  $default,) {final _that = this;
switch (_that) {
case _SignUpRequestModel():
return $default(_that.name,_that.email,_that.password,_that.avatar);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String name,  String email,  String password,  String avatar)?  $default,) {final _that = this;
switch (_that) {
case _SignUpRequestModel() when $default != null:
return $default(_that.name,_that.email,_that.password,_that.avatar);case _:
  return null;
...
class _SignUpRequestModel implements SignUpRequestModel {
  const _SignUpRequestModel({required this.name, required this.email, required this.password, required this.avatar});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _SignUpRequestModel&&(identical(other.name, name) || other.name == name)&&(identical(other.email, email) || other.email == email)&&(identical(other.password, password) || other.password == password)&&(identical(other.avatar, avatar) || other.avatar == avatar));
}
...
/// Create a copy of SignUpRequestModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? email = null,Object? password = null,Object? avatar = null,}) {
